...
check("시작일이 있으면 상대적인 이름", dayInfo("1일차", "2026-08-13").label, "오늘");
check("셋째 날은 모레", dayInfo("3일차", "2026-08-13").label, "모레");
check("범위를 벗어나면 요일 이름", dayInfo("5일차", "2026-08-13").label, "월요일");
