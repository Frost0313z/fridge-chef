...
| 냉장고 (`pantry.html`) | 재료를 넣고 빼고 한눈에 보기. **재료를 지울 수 있는 유일한 화면** (추가는 다른 화면의 조회 바에서도 가능) |
...
- **냉장고 단일 출처** — 나머지 화면은 헤더 아래 접이식 조회 바로 현황을 확인하고, 거기서 **추가**도 할 수 있다. **삭제는 냉장고에서만** — 되돌릴 수 없는 조작에만 마찰을 남긴다
